...
class TablesList {
  ...
  static final CUSTOMERMASTER = "Customer_Master";
  static final LOANMASTER = "Loan_Master";
  static final GUARANTERMASTER = "Guaranter_Master";
  static final COLLATERALSMASTER = "Collaterals_Master";
  static final DOCUMENTSMASTER = "Documents_Master";
  static final USERMASTER = "User_Master";
  static final lOOKUPMASTER = "Lookup_Master";
  static final SYSTEMPARAMETERSMASTER = "System_Parameter_Master";
  static final INTERESTSLANMASTER= "Interest_Slab_Master";
  static final INTERESETOFFSETMASTER= "Interest_Offset_Master";
