...
class AddExistingCollateralsAgain extends StatefulWidget {
  final collateralsDetailsPassedObject;
  final String mleadsId;
  final int mrefno;
  final int trefno;
  final int mcardtrefno;
  final int mcardmrefno;
  final int mcusttrefno;
  final int mcustmrefno;
  AddExistingCollateralsAgain({Key key, this.collateralsDetailsPassedObject,this.mleadsId,this.mrefno,this.trefno,this.mcardtrefno,this.mcardmrefno,this.mcusttrefno,this.mcustmrefno}) : super(key: key);
  ...
  @override
  _AddExistingCollateralsAgainState createState() => new _AddExistingCollateralsAgainState();
}

class _AddExistingCollateralsAgainState extends State<AddExistingCollateralsAgain> {
  ...
  void initState() {
    ...
    super.initState();
    print("widget.collateralsDetailsPassedObject"+widget.collateralsDetailsPassedObject.toString());
          ...
          body: new Form(
            ...
            new Container(
              ...
              /*  Card(
               ...
               /* new Card(
                  child: new ListTile(
                    title: new Text(Translations.of(context).text('flag')),
                    subtitle: new Text(
                      "${collateralobj.mflag.toString() != null && collateralobj.mflag.toString() != 'null' ?collateralobj.mflag.toString() : ""}",
                    ),
                  ),
                ),*/
                new Card(
  ...
  submitCollateralAndRoute() async{
    ...
    print("chduycfd");
    print(collateralobj.mflag);
    /*print(collateralobj.mcustmrefno);    await AppDatabase.get()
